<div class="drawer-side is-drawer-close:overflow-visible ">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64 is-drawer-close:w-14 is-drawer-open:w-80">
        ...
        <ul class="menu w-full grow gap-1">
            ...
            <!-- Beli Tiket (Home) Item -->
            <li class="{{ request()->routeIs('home') ? 'bg-gray-200 rounded-lg' : '' }}">
                <a href="{{ route('home') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
                    data-tip="Beli Tiket">
                    <!-- Ticket icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path
                            d="M20 12c0-1.1.9-2 2-2V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v3c1.1 0 2 .9 2 2s-.9 2-2 2v3a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-3c-1.1 0-2-.9-2-2Z">
                        </path>
                    </svg>
                    <span class="is-drawer-close:hidden">Beli Tiket</span>
                </a>
            </li>
